...
namespace ShadowNova
{
    class Actor
    {
        ...
        public Actor()
        {
            ...
            expMilitary = Program.r.Next(0,999);
            expAdmin = Program.r.Next(0,999);
        }
        ...
        public void loadActor()
        {
            ...
            if (dbCon.IsConnect())
            {
                ...
                while (reader.Read())
                {
                    ...
                    reader.GetInt32(2), reader.GetBoolean(3), reader.GetInt32(4),
        ...
        public void saveActor()
        {
            ...
            if (dbCon.IsConnect())
            {
                ...
                //Actor
                for (int j = 0; j < Global.actorList.Count(); j++)
                {
